    ...
    <div class="header">
        <header class="container-fluid p-3 bg-dark">
            <nav class="navbar container navbar-expand-sm">
                <h1 class="col-2 text-white"><a href="index.php" class="text-white" style="text-decoration: none;">LOGO</a></h1>
                ...
                <div class="col-6">
                    <ul class="navbar-nav justify-content-end ms-5">
                        ...
                        <li class="nav-item"><a class="nav-link active text-white" href=""><i class="fa-solid fa-cart-shopping"></i> Cart</a></li>
                        <li class="nav-item"><a class="nav-link active text-white" href="" data-bs-toggle="modal" data-bs-target="#signin"><i class="fa-solid fa-user-large"></i> Sign In</a></li>
                        <li class="nav-item"><a class="nav-link active text-white" href="" data-bs-toggle="modal" data-bs-target="#signup">Sign Up</a></li>
                    </ul>
                </div>
            </nav>
        </header>
